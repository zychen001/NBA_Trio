<template>
  <a-carousel autoplay>
    <a-image v-for="image in curList" :src="image" :width="1720"  />
  </a-carousel>
</template>
...
export default {
      ...
      return {
        ...
        // OKC
          'Durant_Westbrook_Harden':
            ...
            'https://cdn.vox-cdn.com/thumbor/4i3gXd11naj_bhaNcDHDyFf-0ug=/0x0:2974x1983/1200x800/filters:focal(0x0:2974x1983)/cdn.vox-cdn.com/uploads/chorus_image/image/49749179/usa-today-9317475.0.jpg',
    ...
    mounted: function() {
      this.curList = this.images[this.$route.query.name];
    },
